...
Item {
    Button {
        ...
        contentItem: Text {
            ...
            // Mostrar estado actual del teclado virtual
            text: virtualKeyboardButton.checked ? 
                  (config.TranslateVirtualKeyboardButtonOn || "Virtual Keyboard (on)") :
                  (config.TranslateVirtualKeyboardButtonOff || "Virtual Keyboard (off)")
        ...
        states: [
            ...
            State {
                ...
                PropertyChanges {
                    target: virtualKeyboardButtonText
                    color: config.VirtualKeyboardButtonTextColor
                }
            },
            State {
                name: "hovered"
