...
ColumnLayout {
    ...
    // El teclado virtual NO se activa automáticamente cuando se hace focus en campos.
    // Se debe presionar explícitamente el botón "Virtual Keyboard" para activarlo.
    // Esto proporciona mejor control en dispositivos con teclado físico.
